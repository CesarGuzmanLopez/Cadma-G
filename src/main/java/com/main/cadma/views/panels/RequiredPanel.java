...
public class RequiredPanel extends JPanel{
    ...
    public RequiredPanel(String title, ActionsCadma actions) {
        ...
        try{
            ...
            tache = resize(tache, 30, 30);
            paloma = resize(paloma, 30, 30);
            neutro = resize(neutro, 30, 30);
            circulo = resize(circulo, 30, 30);
        } catch(Exception e){
